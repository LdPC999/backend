...
export default function HeroSlider() {
  useEffect(() => {
    ...
    while (i < slides.length - 1) {
      tl.to(`.hero${i} h2`, { clipPath: "polygon(0% 0%, 0% 0%, 0% 100%, 0% 100%)", delay: 2 })
        .to(`.hero${i} h1`, { clipPath: "polygon(0% 0%, 0% 0%, 0% 100%, 0% 100%)" }, "-=0.3")
        .to(`.hero${i} h3`, { clipPath: "polygon(0% 0%, 0% 0%, 0% 100%, 0% 100%)" }, "-=0.3")
        .to(`.hero${i} .home-slider-image`, { clipPath: "polygon(0% 0%, 0% 0%, 0% 100%, 0% 100%)" }, "-=1")
